...
instance : RawDecode ElfVersion UInt32 where
  ofRaw
...
instance : RawDecode ElfType UInt16 where
  ofRaw
  | 0 => .ok .none
  | 1 => .ok .rel
  | 2 => .ok .exec
...
instance : RawDecode ElfMachine UInt16 where
  ofRaw
  | 62  => .ok .x86_64
  | 183 => .ok .aarch64
...
instance : RawDecode ElfShstrndx UInt16 where
  ofRaw
