...
if [ ! -x "$THIRD_PARTY_DIR/impl-loader/musl/configure" ]; then
  echo "missing musl source at $THIRD_PARTY_DIR/impl-loader/musl; run ../setup.sh from the LeanLoad umbrella checkout or set THIRD_PARTY_DIR" >&2
  exit 1
fi
