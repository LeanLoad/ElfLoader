...
import ElfLoader.Parse.DynMap.Basic
import ElfLoader.Parse.Reloc.Table
import ElfLoader.Parse.Symbol.Checked
import ElfLoader.Parse.Symbol.SysVHash
import ElfLoader.Parse.CallTargets
import ElfLoader.Parse.LoadMap.Basic
import ElfLoader.Parse.LoadMap.ProgramHeader.Basic
import ElfLoader.Parse.LoadMap.ProgramHeader.Map
...
/-- Parse `.dynsym` using `DT_HASH.nchain` as the symbol count. ElfLoader requires
