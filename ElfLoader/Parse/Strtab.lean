...
is ElfLoader's interpretation, consistent with how every Linux
...
import ElfLoader.Parse.Decode.Decoder
...
/-- A string-table offset resolved against a concrete string table.
    ...
    offset is valid for this table under ElfLoader's UTF-8
